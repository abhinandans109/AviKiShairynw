...
import com.shivam.avikishayri.databinding.HafiFragmentBinding;
...
public class hafi_fragment extends Fragment  {
    private MediaPlayer player;
    HafiFragmentBinding binding;
    ProgressBar progressBar;
    Boolean f;
    int i=0;
    private Fragmenthafilistener fragmenthafilistener;
    private List<ShairyData> list=new ArrayList<>();
    private String mp3url;
    public interface Fragmenthafilistener{
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        binding=HafiFragmentBinding.inflate(inflater,container,false);
...
//                Toast.makeText(getActivity(), "Loading Please Wait..", Toast.LENGTH_SHORT).show();
        ...
        FirebaseDatabase.getInstance().getReference("Tehzeeb Hafi").addValueEventListener(new ValueEventListener() {
            @Override
...
//        Toast.makeText(this, shairyData.getShair(), Toast.LENGTH_SHORT).show();
        ...
        fragmenthafilistener.Oninputsent(s);
    ...
    public void nextClicked() {
        ...
        binding.shairy1.setText(shairyData.getShairy());
        mp3url=shairyData.getAudio();
        fragmenthafilistener.Oninputsent(shairyData.getShairy());


    }

    public void playbutton() {
        fragmenthafilistener.onplayerinstancesent(player);
...
//        Toast.makeText(getActivity(), getshayritext(), Toast.LENGTH_SHORT).show();
    ...
    public void onAttach(@NonNull @NotNull Context context) {
        ...
        fragmenthafilistener=(Fragmenthafilistener) context;
    }
}
